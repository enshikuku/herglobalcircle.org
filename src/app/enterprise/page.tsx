...
export const metadata: Metadata = {
  ...
  description: "H.E.R Enterprise is now part of the About Us page.",
  ...
  return (
    <section className="texture-paper py-20 sm:py-28">
      <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        <BriefcaseBusiness className="mx-auto h-10 w-10 text-gold" aria-hidden="true" />
        <p className="section-kicker mt-5">H.E.R Enterprise</p>
        <h1 className="mt-4 text-5xl font-bold leading-tight text-forest sm:text-6xl">
          H.E.R Enterprise is now part of About Us.
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-ink/70">
          Visit About Us for the foundation structure, community platform,
          Enterprise focus areas and initiative links.
        </p>
        <Link
          href="/about/"
          prefetch={false}
